...
public class TC_AED_MemberShip extends TestCaseBase {
    ...
    public void test() throws MalformedURLException, InterruptedException{
        ...
        try{
            ...
            LoginUsuario(login);
            //Step2
            NavegarAMemeberships();
            //Step3
            NavegarAAgregarMemebership();
            //Step4
            CrearMemebership();
            //Step5
            EditarMemebership();
    ...
    public void NavegarAMemeberships(){
        log.reporta("INFO","Step2: Navegar a Memeberships");

    }
    // </editor-fold>

    // <editor-fold desc="Step3">
    public void NavegarAAgregarMemebership(){
        log.reporta("INFO","Step3: Navegar a AddMemebership");

    }
    // </editor-fold>

    // <editor-fold desc="Step4">
    public void CrearMemebership() {
        log.reporta("INFO","Step4: Agregar Memebership");

    }
    // </editor-fold>

    // <editor-fold desc="Step5">
    public void EditarMemebership(){
        log.reporta("INFO","Step5: Editar Memebership");

    }
    // </editor-fold>

    // <editor-fold desc="Step6">
    public void EliminarMemebership(){
        log.reporta("INFO","Step6: Eliminar Memebership");
