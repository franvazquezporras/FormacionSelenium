...
public class AdminOrganizationAddLocationPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de creación de una nueva Location.
     *
     * @param driver    Driver del navegador.
     * @param log       Gestor de logs.
     * @param mainClass Clase principal que ejecuta la prueba.
     */
    public AdminOrganizationAddLocationPageObject(WebDriver driver, LogManager log, String mainClass){
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de creación de Location esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Save.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnSave,"Pantalla Agregar Location");
    }
// </editor-fold>
