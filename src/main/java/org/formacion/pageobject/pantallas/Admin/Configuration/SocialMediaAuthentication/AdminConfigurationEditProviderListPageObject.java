...
public class AdminConfigurationEditProviderListPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de edición de un proveedor.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de edición de proveedor esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Save.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnSave,"Pantalla Editar Provider");
    }
// </editor-fold>
