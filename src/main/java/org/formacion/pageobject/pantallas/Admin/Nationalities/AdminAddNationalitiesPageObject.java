...
public class AdminAddNationalitiesPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de creación de una nueva Nationality.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de creación de Nationality esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Save.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnSave,"Pantalla Agregar Nationality");
    }
// </editor-fold>
