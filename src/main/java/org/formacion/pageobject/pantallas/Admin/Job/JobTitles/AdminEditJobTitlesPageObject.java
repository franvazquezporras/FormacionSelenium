...
public class AdminEditJobTitlesPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de edición de un Job Title.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de edición de Job Title esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Save.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnSave,"Pantalla Editar Job Title");
    }
// </editor-fold>
...
// -------------------------
     ...
     * Guarda los cambios realizados en el Job Title.
     */
