...
public class AdminWorkShiftsPageObject extends BasePageObject {
...
// <editor-fold desc="Constructor">
    /**
     * Constructor del Page Object para la pantalla de listado de Work Shifts.
     *
     * @param driver    Driver del navegador.
     * @param log       Gestor de logs.
     * @param mainClass Clase principal que ejecuta la prueba.
     */
    public AdminWorkShiftsPageObject(WebDriver driver, LogManager log, String mainClass){
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de Work Shifts esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Agregar.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnAgregar,"Pantalla Work Shifts");
    }
// </editor-fold>
...
// -------------------------
     ...
     * Se utiliza para seleccionar o deseleccionar el Work Shift.
     */
...
// -------------------------
     ...
     * Abre la pantalla para crear un nuevo Work Shift.
     */
     ...
     * Elimina el Work Shift actualmente seleccionado.
     */
     ...
     * Elimina todos los Work Shifts marcados en la lista.
     */
     ...
     * Abre la pantalla de edición del Work Shift seleccionado.
     */
