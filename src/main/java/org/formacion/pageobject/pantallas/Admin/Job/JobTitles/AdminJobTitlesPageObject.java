...
public class AdminJobTitlesPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de listado de Job Titles.
     *
     * @param driver    Driver del navegador.
     * @param log       Gestor de logs.
     * @param mainClass Clase principal que ejecuta la prueba.
     */
    public AdminJobTitlesPageObject(WebDriver driver, LogManager log, String mainClass){
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de Job Titles esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Agregar.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnAgregar,"Pantalla Jobs Titles");
    }
// </editor-fold>
...
// -------------------------
     ...
     * Se utiliza para seleccionar o deseleccionar el Job Title.
     */
...
// -------------------------
     ...
     * Abre la pantalla para crear un nuevo Job Title.
     */
     ...
     * Elimina el Job Title actualmente seleccionado.
     */
     ...
     * Elimina todos los Job Titles marcados en la lista.
     */
     ...
     * Abre la pantalla de edición del Job Title seleccionado.
     */
