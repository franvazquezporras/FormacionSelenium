...
public class AdminQualificationsAddMemberShipPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de creación de un nuevo Membership.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de creación de Membership esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Save.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnSave,"Pantalla Agregar Member ship");
    }
// </editor-fold>
