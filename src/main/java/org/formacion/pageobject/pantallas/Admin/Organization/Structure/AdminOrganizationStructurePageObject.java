...
public class AdminOrganizationStructurePageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de Structure dentro del módulo Organization.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de Structure esté completamente cargada.
     * Se sincroniza verificando la presencia del checkbox de edición.
     */
    public void esperarSincronizacion(){
        esperarPagina(checkEditar,"Pantalla Structure");
    }
// </editor-fold>
