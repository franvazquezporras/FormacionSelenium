...
public class AdminQualificationsLicensesPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de listado de Licenses.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de Licenses esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Agregar.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnAgregar,"Pantalla Licenses");
    }
// </editor-fold>
...
// -------------------------
     ...
     * Se utiliza para seleccionar o deseleccionar la License.
     */
...
// -------------------------
     ...
     * Abre la pantalla para crear una nueva License.
     */
     ...
     * Elimina la License actualmente seleccionada.
     */
     ...
     * Elimina todas las Licenses marcadas en la lista.
     */
     ...
     * Abre la pantalla de edición de la License seleccionada.
     */
