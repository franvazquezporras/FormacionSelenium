...
public class AdminAddEmploymentStatusPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de creación de un nuevo Employment Status.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de creación de Employment Status esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Save.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnSave,"Pantalla Agregar Employment status");
    }
// </editor-fold>
