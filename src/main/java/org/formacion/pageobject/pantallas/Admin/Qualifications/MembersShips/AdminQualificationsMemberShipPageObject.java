...
public class AdminQualificationsMemberShipPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de listado de Memberships.
     *
     * @param driver    Driver del navegador.
     * @param log       Gestor de logs.
     * @param mainClass Clase principal que ejecuta la prueba.
     */
    public AdminQualificationsMemberShipPageObject(WebDriver driver, LogManager log, String mainClass){
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de Memberships esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Agregar.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnAgregar,"Pantalla Members Ships");
    }
// </editor-fold>
...
// -------------------------
     ...
     * Se utiliza para seleccionar o deseleccionar el Member Ship.
     */
...
// -------------------------
     ...
     * Abre la pantalla para crear un nuevo Member Ship.
     */
     ...
     * Elimina el Member Ship actualmente seleccionado.
     */
     ...
     * Elimina todos los Member Ships marcados en la lista.
     */
     ...
     * Abre la pantalla de edición del Member Ship seleccionado.
     */
