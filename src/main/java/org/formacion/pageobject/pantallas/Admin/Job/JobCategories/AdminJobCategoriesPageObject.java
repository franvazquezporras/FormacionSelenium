...
public class AdminJobCategoriesPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de listado de Job Categories.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de Job Categories esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Agregar.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnAgregar,"Pantalla Jobs Categories");
    }
// </editor-fold>
...
// -------------------------
     ...
     * Se utiliza para seleccionar o deseleccionar la Job Category.
     */
...
// -------------------------
     ...
     * Abre la pantalla para crear una nueva Job Category.
     */
     ...
     * Elimina la Job Category actualmente seleccionada.
     */
     ...
     * Elimina todas las Job Categories marcadas en la lista.
     */
     ...
     * Abre la pantalla de edición de la Job Category seleccionada.
     */
