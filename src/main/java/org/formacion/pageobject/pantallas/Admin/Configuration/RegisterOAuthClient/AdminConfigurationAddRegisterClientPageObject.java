...
public class AdminConfigurationAddRegisterClientPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de registro de un nuevo cliente.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de registro de cliente esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Save.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnSave,"Pantalla Agregar Client");
    }
// </editor-fold>
