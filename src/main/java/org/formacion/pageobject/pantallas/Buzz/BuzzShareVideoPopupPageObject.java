...
public class BuzzShareVideoPopupPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para el popup de compartir un video en Buzz.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que el popup de compartir video esté completamente cargado.
     * Se sincroniza verificando la presencia del campo de texto del post.
     */
    public void esperarSincronizacion(){
        esperarPagina(txtPost,"Popup Share Video");
    }
// </editor-fold>
