...
public class ClaimConfigurationEditEventPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de edición de un evento de reclamo.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de edición de evento esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Save.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnSave,"Pantalla Editar Evento");
    }
// </editor-fold>
