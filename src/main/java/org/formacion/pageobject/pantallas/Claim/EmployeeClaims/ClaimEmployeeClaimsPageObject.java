...
public class ClaimEmployeeClaimsPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de reclamos del empleado.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de reclamos del empleado esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Assign Claim.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnAssignClaim,"Pantalla Employee Claims");
    }
// </editor-fold>
