...
public class PerformanceCofigureKPIsPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de configuración de KPIs
     * dentro del módulo de Performance.
     *
     * Esta vista permite gestionar los indicadores clave de desempeño (KPIs),
     * incluyendo su creación, edición y asignación a roles o evaluaciones
     * dentro del sistema.
     *
    ...
    /**
     * Espera a que la pantalla de configuración de KPIs esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Agregar KPI.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnAgregarKPI,"Pantalla KPIs");
    }
    // </editor-fold>
