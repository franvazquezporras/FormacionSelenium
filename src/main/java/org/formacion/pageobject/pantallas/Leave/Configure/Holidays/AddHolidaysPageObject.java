...
public class AddHolidaysPageObject extends BasePageObject {
    ...
    /**
     * Constructor del Page Object para la pantalla de creación de días festivos.
     *
     * Esta vista permite registrar nuevos feriados dentro del módulo de Leave,
     * especificando nombre, fecha y tipo de día festivo.
     *
...
// <editor-fold desc="Sincronizacion">
    /**
     * Espera a que la pantalla de creación de días festivos esté completamente cargada.
     * Se sincroniza verificando la presencia del botón Save.
     */
    public void esperarSincronizacion(){
        esperarPagina(btnSave,"Pantalla Add Holidays");
    }
// </editor-fold>
